    ...
    return (
        <div className="bg-white shadow-xl h-[250px] hover:cursor-pointer">
            <div className="flex flex-col p-4 h-full">
                <h1 className="flex basis-1/4 font-bold lg:text-2xl md:text-lg text-md text-[#1E1E1E]">{title}</h1>
                <p className="flex basis-1/2 font-lighter text-[#1E1E1E] max-h-[185px] text-ellipsis overflow-hidden line-clamp-4">{overview}</p>
